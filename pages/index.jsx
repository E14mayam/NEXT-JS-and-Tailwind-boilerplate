  ...
  return (
    <div className="text-center home">
      <div className="welcome-wrapper pb-20 md:pb-10 lg:pb-10">
        ...
        <h3 className="pt-4 pb-8 font-medium animate__animated animate__fadeInDown animate__slow">
          This is the Kings Assembly
        </h3>
        <a
          href="#"
        ...
        <img
          className="h-auto relative rounded-xl mx-auto pt-5 pb-10 animate__animated animate__fadeInUp animate__slow"
      ...
      <div className="excel-bulletin py-20">
        ...
        <h3 className="pt-4 pb-8 font-medium animate__animated animate__fadeInDown animate__slow w-10/12 mx-auto">
          The Excel Bulletin is our weekly publication that contains everything
          you need to know about us and our events for a particular week. It
          also contains inspiration and timely messages to get you through your
          week. I&aposs free! Click on the button and download this week’s copy.
          You can share it with your friends.
        </h3>
        <a
          href="https://thechurchco-production.s3.amazonaws.com/uploads/sites/2482/2022/07/BULLETIN-10TH-JULY-2022.pdf"
          className="px-10 py-4 text-zinc-50 bg-[#8000ff] rounded-full text-base font-semibold"
        >
          Download Here
        </a>
      </div>
      ...
      <div className="contact-form py-20">
        ...
        <form action="#" className="flex flex-col md:px-10 lg:px-20">
          <input
            type="text"
            name="name"
            className="my-2 bg-zinc-900 border-b-2 border-violet-500 outline-0 focus:bg-zinc-900 px-2 py-2"
          ...
          <textarea
            ...
            cols="30"
            rows="10"
            className="my-2 bg-zinc-900 border-2 border-violet-500 outline-0 focus:bg-zinc-900 px-2 py-2 rounded-sm"
            placeholder="What would you like us to know"
          ></textarea>
          <button className="px-10 py-4 text-[#8000ff] bg-zinc-50 rounded-full text-base font-semibold border-link">
            Submit
          </button>
        </form>
